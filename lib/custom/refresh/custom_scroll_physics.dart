...
typedef ViewPort(bool);

class BouncingScrollPhysics extends ScrollPhysics {
  /// Creates scroll physics that bounce back from the edge.

  const BouncingScrollPhysics({ScrollPhysics parent, ViewPort viewPort})
      :super(parent: parent) ;

  @override
  BouncingScrollPhysics applyTo(ScrollPhysics ancestor) {
    print("BouncingScrollPhysics:applyTo():");
  ...
  double applyBoundaryConditions(ScrollMetrics position, double value) {
    print("BouncingScrollPhysics:applyBoundaryConditions():");
    return 0;
  }
  ...
  Simulation createBallisticSimulation(
    ...
    print("BouncingScrollPhysics:createBallisticSimulation():");
